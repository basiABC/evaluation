...
public:
    ...
    Node(const QString& name, QGraphicsScene* scene, Node* parent = nullptr, QWidget* mainWindow = nullptr)
        : QGraphicsObject(nullptr), name(name), scene(scene), parent(parent), mainWindow(mainWindow) {
        initializeNode();
    }
